      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-2">
            <motion.a
              href="#inicio"
              onClick={(e) => { e.preventDefault(); voltarAoTopo() }}
            ...
            <p className="text-gray-400 mb-6 max-w-md">
              Motor do seu crescimento digital. Unimos pontualidade, integridade e foco em vendas
              para transformar o seu negócio em um resultado real.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-gray-500 text-sm">
              © {anoAtual} Bueno Mídias. Todos os direitos reservados.
            </p>
            <motion.button
