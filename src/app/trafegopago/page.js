    ...
    <main className="min-h-screen bg-dark-900">
              ...
              return (
                ...
                >
                  ...
                  >
                    {/* Gradiente de Fundo */}
                    <div
                      className={`absolute top-0 right-0 w-64 h-64 bg-gradient-to-bl ${gradiente} rounded-full blur-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-500`}
                    />
                    ...
                    <div className="relative z-10">
                      ...
                      <h3 className="text-2xl font-bold text-white mb-3 group-hover:text-cyber-primary transition-colors">
                        {t(`trafegoPago.platforms.${chave}.title`)}
                      </h3>

                      {/* Descrição */}
                      <p className="text-gray-400 mb-6">
                        {t(`trafegoPago.platforms.${chave}.description`)}
                      </p>
      ...
      <section id="resultados" ref={refResultados} className="relative py-24 lg:py-32 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Carrossel de Resultados - Loop Infinito */}
          <motion.div
            initial={{ opacity: 0 }}
          ...
          >
            ...
            <div className="flex animate-scroll-loop gap-8 w-max hover:[animation-play-state:paused]">
              {/* Imagens duplicadas para loop contínuo */}
              {[...imagensResultados, ...imagensResultados].map((src, indice) => (
                ...
                >
                  <div className="relative bg-dark-800/60 backdrop-blur-sm rounded-2xl border border-dark-600 overflow-hidden hover:border-cyber-primary/30 transition-all duration-500">
                    <img
                      src={src}
                      alt={`${t('trafegoPago.results.imageAlt')} ${(indice % imagensResultados.length) + 1}`}
