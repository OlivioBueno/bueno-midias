      ...
      <div ref={referencia} className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div initial={{ opacity: 0, y: 30 }} animate={estaVisivel ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.6 }} className="text-center mb-16">
          ...
          <motion.h2 initial={{ opacity: 0, y: 20 }} animate={estaVisivel ? { opacity: 1, y: 0 } : {}} transition={{ delay: 0.2 }} className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-4">
            <span className="text-white">{t('services.title')} </span><span className="gradient-text">{t('services.titleGradient')}</span>
          </motion.h2>
          ...
          {servicos.map((servico, indice) => (
            <motion.div key={servico.title} initial={{ opacity: 0, y: 40 }} animate={estaVisivel ? { opacity: 1, y: 0 } : {}} transition={{ delay: 0.4 + indice * 0.15, duration: 0.6 }} className="group">
              <div className="relative h-full bg-dark-800/60 backdrop-blur-sm rounded-2xl p-8 border border-dark-600 hover:border-opacity-50 transition-all duration-500 card-hover overflow-hidden">
                <div className={`absolute top-0 right-0 w-64 h-64 bg-gradient-to-bl ${servico.gradiente} rounded-full blur-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-500`} />
